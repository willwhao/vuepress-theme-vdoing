...
手写春联：<https://cl.willwhao.com/>

### 前言

虎年春节快到了，首先祝大家新年快乐，轻松暴富。
最近在网上经常看到生成春联的文章，不过这些小 demo 要么功能简陋,要么 UI 特别‘程序员’，满足不了我挑剔的眼光。干脆我自己做一个吧，顺便简单体验一下 vite+vue3。（因为页面相对简单，vue 组件风格还是使用选项式 api，重点还是想把产品快速做出来。）
  ...
  <div class="wrap" :class="'mode-' + mode" @touchstart="handleTouchstart">
    ...
    <div v-if="isReadImages">
      ...
      <img
        ...
        class="hide-img"
        id="qrcode"
        src="https://cdn.staticaly.com/gh/willwhao/image_store2@master/img/qrcode.zul0pldsuao.png"
      />
    </div>

    <!-- 背景音乐 -->
    <audio
      src="https://cdn.staticaly.com/gh/willwhao/image_store2@master/cjxq.mp3"
      id="bgm"
      ref="bgm"
      loop
    />
...
export default {
  ...
  data() {
    return {
      ...
      bgList: [
        'https://cdn.staticaly.com/gh/willwhao/image_store@master/1.4j8qpdnq80i0.jpeg',
        'https://cdn.staticaly.com/gh/willwhao/image_store@master/4.4460an8ag5o0.jpeg',
        'https://cdn.staticaly.com/gh/willwhao/image_store@master/5.3axtl4xpvy00.jpeg',
        'https://cdn.staticaly.com/gh/willwhao/image_store@master/6.2lnbphdqjaq0.jpeg',
      ],
...
> [手写春联](https://cl.willwhao.com/)</br> > [FC 在线模拟器](https://game.willwhao.com/)</br> > [爱国头像生成器](https://avatar.willwhao.com/)</br> > [到账语音生成器](https://zfb.willwhao.com/)
