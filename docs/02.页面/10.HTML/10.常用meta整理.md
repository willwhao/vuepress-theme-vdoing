...
```html
默认用极速核(Chrome)：<meta name="renderer" content="webkit" /> 默认用ie兼容内核（IE6/7）：<meta name="renderer" content="ie-comp" /> 默认用ie标准内核（IE9/IE10/IE11/取决于用户的IE）：<meta name="renderer" content="ie-stand" />
```
...
![](https://cdn.staticaly.com/gh/willwhao/image_store/blog/20200221134927.jpg)
...
![](https://cdn.staticaly.com/gh/willwhao/image_store/blog/20200221134638.png)
